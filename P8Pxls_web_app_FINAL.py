...
if uploaded_file:
    try:
        ...
        # Identifica todas as colunas chamadas "Data" e renomeia a última para "Data do TVI"
        data_cols = [col for col in df.columns if col.strip().lower() == "data"]
        if not data_cols:
            raise Exception("Nenhuma coluna chamada 'Data' foi encontrada no CSV.")
