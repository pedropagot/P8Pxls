...
if arquivo:
    ...
    razao_social = "LBM COMERCIO E SERVICOS LTDA"  # Exemplo, em produção isso viria do DataFrame
    nome_arquivo_formatado = f"Planilha de Cálculo - {razao_social.upper().replace(' ', '_')}.xlsx"
    st.download_button("📥 Baixar Planilha de Cálculo + Quadro Resumo", buffer1.getvalue(), file_name=nome_arquivo_formatado)
